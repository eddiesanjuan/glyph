...
| Invoice | `invoice-modern`, `invoice-classic` | Planned — [request access](mailto:hello@glyph.you) |
| Proposal | `proposal-executive`, `proposal-minimal` | Planned — [request access](mailto:hello@glyph.you) |
